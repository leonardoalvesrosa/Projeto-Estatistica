...
function calcular(){
    ...
    console.log('intervalo : ' + intervalo.value)
    console.log('media : ' + media + ', ' + typeof(media))
    console.log('dp : ' + dp + ', ' + typeof(dp))
    //console.log('qtde : ' + qtde + ', ' + typeof(qtde))
    ...
    //Função pra transformar z-------------------------------------------------------------------------------

    function conversao(x) {
        var posi = x  //Esse será o número z que será convertido
        ...
        if(posi < 4){
            ...
            console.log('posi: ' + posi + ', ' + typeof(posi))


            var posiVet = posi.toFixed(2) //Arredondando o valor z recebido para duas casas decimais
            console.log('posiVet: ' + posiVet + ', ' + typeof(posiVet))

            var posiObj = Number(posiVet)
            posiObj = Math.trunc(posiObj * 10) 
            posiObj = posiObj / 10
            console.log('posiObj: ' + posiObj + ', ' + typeof(posiObj))
    ...
    if(intervalo.value === 'entre') {
        ...
        else if( fim > media && inicio > media){
            z1 = (inicio - media) / dp
            z2 = (fim - media) / dp
            //transformar z1 e z2
            z1 = conversao(z1)
